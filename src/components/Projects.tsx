...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Real-time weather dashboard with location-based forecasts, interactive maps, and detailed weather analytics with beautiful data visualizations.",
    ...
    },
    {
      ...
      description: "Comprehensive social media analytics platform that tracks engagement, growth metrics, and provides actionable insights for content creators.",
    ...
    },
    {
      ...
      description: "A responsive portfolio website showcasing modern design principles, smooth animations, and optimal user experience across all devices.",
    ...
    },
    {
      ...
      description: "Educational platform with course management, progress tracking, interactive quizzes, and video streaming capabilities for online learning.",
